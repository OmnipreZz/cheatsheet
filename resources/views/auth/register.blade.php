        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-secondary">Créer un nouvel utilisateur</h2>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin_store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" placeholder="Mot de passe" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
